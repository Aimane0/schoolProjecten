...
```
2204 heeft een lagere bandwidth, memory, sample rate dan de 2205 en 2206.\
Ook zijn de 2205 en 2206 duurder.
```
...
```
Je betaalt 80 euro meer voor 15 meer MHz.
Dat is 5.33333333 euro meer per MHz.
```

Wat is de maximale spanning die je op de ingangen mag plaatsen?

```
100 volt is de maximale spanning
```
...
```
Zo kun je vergelijkingen maken. 
Als je twee ingangen hebt kun je twee signalen vergelijken.
```
...
1: DC average, toont gemiddelde voltage

2: Maximum, hoogst gemeten meting gedaan door de picoscope

3: Minimum, laagst gemeten meting gedaan door de picoscope
...
```
Square, Triangle, Ramp Up, Ramp Down, Sin (x)/x, Guassian, Half Sine, Sine, Arbitrary (AWG), DC Voltage
```
...
```
Het is een generator waarmee je je eigen cycles, vormen etc kunt aangeven.
```
...
1: Auto, wacht op een trigger maar ten opzichte van de andere soorten toont het na een bepaalde tijd wachten als die geen trigger ontvangt alsnog data.

2: Repeat, wacht op een trigger en blijft voor onbepaalde tijd wachten en toont geen data als er geen trigger is geweest.
 
3: Single, doet maar aan één sample als het de trigger ontvangt.

4: ETS, meerdere samples van de zelfde tijd en combineert de resultaten tot 1 golflengte. Is preciezer dan de andere.
...
```
Met persistence mode kun je makkelijker glitches vinden
```
...
```
1: Checken of je output voltage consistent is.

2: Controleren of je apparatuur werkt of kapot is.
...
```
De eigenschappen staan hier onder gegeven.
Ook de instelbaarheid.
```
...
```
Schermafdruk:
![Rimpel](https://github.com/TICT-TV1SE2-2324/kas-project-parkrangers/blob/main/portfolio/oscilloscope/oscilloscope_1.png)
...
```
Grootte rimpelspanning in mV: We kunnen in de Arduino Uno het niet in de datasheet vinden.

Voor de type 10818 vonden we het antwoord 1%
```
...
```
Op alle drie onze telefoons zien wij de kleur paars
```
...
```
26.72 microseconde is 1 cyclus
26.72 / 1 000 000 = 0.00002672
1 / 0.00002672 = 37425,1497 Hz
```
![Pulsen IR](https://github.com/TICT-TV1SE2-2324/kas-project-parkrangers/blob/main/portfolio/oscilloscope/oscilloscope_2.png)
...
pariteit) is: 9 / 0.003816 miliseconde = 2358.49

We lezen 1001010 uit het plaatje.
Hexadecimaal is het 4a
Volgens ascii is het J, de hoofdletter
![J in putty](https://github.com/TICT-TV1SE2-2324/kas-project-parkrangers/blob/main/portfolio/oscilloscope/oscilloscope_4.png)
...
Hoge signaal is 3.578 volt
Het lage signaal is 0.085 volt 
...
![Pulsen IR](https://github.com/TICT-TV1SE2-2324/kas-project-parkrangers/blob/main/portfolio/oscilloscope/oscilloscope_5.png)

Bits (0/1) op volgorde: 01110111
...
![Pulsen IR](https://github.com/TICT-TV1SE2-2324/kas-project-parkrangers/blob/main/portfolio/oscilloscope/oscilloscope_10.png)
